...
const AllProcess = () => {
    ...
    const slidesData = [
        ...
        {
            title: title14,
            description: 'From idea to global brand, we turned your dream into reality. And this is just the beginning—your brands journey to greatness has only started.',
            icon: 'https://controleur.ca/wp-content/uploads/2021/10/expand.svg'
        },
                    ...
                    <div key={index} className="w-full flex justify-center items-center transition-all duration-500 ease-in-out relative">
                        <div className="text-center relative pb-8 md:pb-12 w-full">
                            ...
                            <div className='flex justify-center items-center w-full'>
                                <img src={slide.title} alt="" className="text-3xl font-bold text-white mb-2 w-28  md:w-40 object-cover" />
                            </div>
                            ...
                            <p
                                ...
                                className={` text-[10px] md:text-[12px] text-white transition-opacity duration-500 ease-in-out ${centerIndex === index ? 'opacity-100' : 'opacity-0'}`}
                            >
                                {slide.description}
                            </p>
                            ...
                            <div className='w-full flex justify-center mt-2  md:mt-10 z-20 items-center relative'>
                                <p
                                    className={`step-number step-number-${index} text-2xl text-black font-bold mr-4 mt-4
                                        ${centerIndex === index ? 'scale-120 rotate-180 text-black flex justify-center items-center rounded-full bg-white border-4 md:border-[6px] border-[#42cabc] w-10 md:w-16 h-10 md:h-16 text-[12px] md:text-[14px]' : 'bg-gray-50 border-2 border-[#4ac6b9] text-gray-900 text-[10px] md:text-[12px]  w-6 md:w-6 h-6 md:h-6 flex justify-center items-center'}`}
                                >
                                    {index + 1}
                                </p>
                            </div>
                        </div>
                        <svg className="absolute w-full h-12 top-28 md:top-44 -z-20 " viewBox="0 0 300 50" preserveAspectRatio="none" ref={waveRef}>
                            <path
                                className="wave-path"
